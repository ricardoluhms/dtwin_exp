...
class VGGBase(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1_1 = nn.Conv2d(3, 16, kernel_size=3, padding=1)  # stride = 1, by default
        ...
        self.conv6 = nn.Conv2d(256, 512, kernel_size=3, padding=6, dilation=6)  # atrous convolution
...
class AuxiliaryConvolutions(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv8_1 = nn.Conv2d(512, 128, kernel_size=1, padding=0)  # stride = 1, by default
        self.conv8_2 = nn.Conv2d(128, 256, kernel_size=3, stride=2, padding=1)  # dim. reduction because stride > 1

        self.conv9_1 = nn.Conv2d(256, 64, kernel_size=1, padding=0)
        self.conv9_2 = nn.Conv2d(64, 128, kernel_size=3, stride=2, padding=1)  # dim. reduction because stride > 1

        self.conv10_1 = nn.Conv2d(128, 64, kernel_size=1, padding=0)
        self.conv10_2 = nn.Conv2d(64, 128, kernel_size=3, padding=0)  # dim. reduction because padding = 0

        self.conv11_1 = nn.Conv2d(128, 64, kernel_size=1, padding=0)
        self.conv11_2 = nn.Conv2d(64, 128, kernel_size=3, padding=0)  # dim. reduction because padding = 0
...
class PredictionConvolutions(nn.Module):
    ...
    def __init__(self, n_classes):
        ...
        self.cl_conv9_2 = nn.Conv2d(128, n_boxes['conv9_2'] * n_classes, kernel_size=3, padding=1)
        self.cl_conv10_2 = nn.Conv2d(128, n_boxes['conv10_2'] * n_classes, kernel_size=3, padding=1)
        ...
        for i in range(batch_size):
            ...
            for c in range(1, self.n_classes):
                ...
                for box in range(class_decoded_locs.size(0)):
                    ...
                    condition = condition.type(torch.cuda.ByteTensor)
